...
public class Day extends Schema {
	private Date date; 
	...
	public Day(Date date) throws SQLException{
		this.date=date;
		...
		ArrayList<Note> bdays = null;
		try{
			bdays = (ArrayList<Note>)DAO.client.queryForList("getBirthdays",params);
		}catch(SQLException e){
			e.printStackTrace();
		}
